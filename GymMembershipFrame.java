...
public class GymMembershipFrame extends JFrame{
    ...
    private JRadioButton monthToMonthRaddBtn;
    ...
    public GymMembershipFrame() {
        ...
        monthToMonthRaddBtn = new JRadioButton("Month-to-month");
        ...
        btngrp.add(monthToMonthRaddBtn);
        ...
        contractsPnl.add(monthToMonthRaddBtn);
